...
public:
  ...
  void enqueue() {
    ...
    cl_int err = clEnqueueNDRangeKernel(
      ...
      static_cast<cl_uint>(actor_facade->config_.dimensions().size()),
      data_or_nullptr(actor_facade->config_.offsets()),
      data_or_nullptr(actor_facade->config_.dimensions()),
      data_or_nullptr(actor_facade->config_.local_dimensions()),
